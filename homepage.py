...
with tab2:
    ...
    st.markdown('<div style="display: inline-block; padding: 5px;border-radius: 10px;text-align: center; font-family: Helvetica; font-size: 16px;color: white; background-color: #124076;">STEP 1</div>', unsafe_allow_html=True)
